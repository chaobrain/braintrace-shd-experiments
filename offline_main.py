...
def add_training_options(parser):
    parser.add_argument(
        "--load_exp_folder", type=str, default=None,
    ...
    parser.add_argument(
        "--state_init", type=str, default='rand', choices=('rand', 'zero'),
    ...
    parser.add_argument(
        "--save_best", type=lambda x: bool(strtobool(str(x))), default=True,
