...
def add_training_options(parser):
    ...
    parser.add_argument("--data_folder", type=str, help="Path to dataset folder.",
                        default=os.path.abspath(
                            os.path.join(os.path.dirname(os.path.realpath(__file__)), './data/SHD/')))
...
def add_model_options(parser):
    ...
    parser.add_argument("--inp_scale", type=float, default=20.)
...
def main():
    ...
    from online_models import Experiment
